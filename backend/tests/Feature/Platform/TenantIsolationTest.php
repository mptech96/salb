...
class TenantIsolationTest extends PlatformControlPlaneTestCase
{
    ...
    public function test_company_portal_uses_company_and_tenant_middleware(): void
    {
        ...
        self::assertStringContainsString("['company.context', 'support.access', 'subscription.access', 'tenant.scope', 'feature.entitlement', 'usage.limit', 'route.permission']", $routes);
    }
